...
#  - ребутаемся и все
#-- Я ОЧЕНЬ РЕКОМЕНДУЮ! Обновить файл Hosts под свои адреса и задачи, прям ковырни самостоятельно.
# ENG ---------------------
#============================================================================================================================
...
#echo -e "bantime = -1" >> $failsrc #-- бантайм - навсегда, но вообще - тоже в секундах
